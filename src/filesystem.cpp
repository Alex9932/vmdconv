...
namespace Engine {
    ...
    void Filesystem_Initialize(String fsjson) {
        ...
        if (fsjson != NULL) {
            ...
            platform = cJSON_GetStringValue(cJSON_GetObjectItemCaseSensitive(json_root, "platform"));
            gamedata = cJSON_GetStringValue(cJSON_GetObjectItemCaseSensitive(json_root, "gamedata"));
            userdata = cJSON_GetStringValue(cJSON_GetObjectItemCaseSensitive(json_root, "userdata"));
            ...
            rgLogWarn(RG_LOG_SYSTEM, "No fstab!");
        }
